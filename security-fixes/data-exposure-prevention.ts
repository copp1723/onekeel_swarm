...
const FIELD_VISIBILITY = {
  ...
  agent: ['id', 'name', 'description', 'status', 'type', 'createdAt', 'updatedAt', 'stats', 'settings'],
  manager: ['id', 'name', 'description', 'status', 'type', 'createdAt', 'updatedAt', 'stats', 'settings', 'createdBy', 'targetCriteria'],
...
function sanitizeSettings(settings: any, userRole: string): any {
  ...
  if (sanitized.handoverCriteria?.handoverRecipients && userRole !== 'admin' && userRole !== 'manager') {
...
export function sanitizeLeadData(lead: any, userRole: string, requestingUserId: string): any {
...
export function sanitizeErrorResponse(error: any, isDevelopment: boolean = false): any {
  if (isDevelopment) {
    return {
