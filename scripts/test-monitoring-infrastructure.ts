...
class MonitoringInfrastructureTest {
  ...
  private async testHealthCheckEndpoints(): Promise<void> {
    ...
    try {
      ...
      if (healthStatus && healthStatus.status && healthStatus.checks) {
        this.addResult('Health Check Endpoints', 'PASS', 
        ...
        this.addResult('Health Check Endpoints', 'FAIL', 
          'Health check returned invalid response structure', duration);
      }
      
    } catch (error) {
      this.addResult('Health Check Endpoints', 'FAIL', 
        `Health check failed: ${error instanceof Error ? error.message : 'Unknown error'}`, 0);
    }
  }
  ...
  private async testSchemaValidationIntegration(): Promise<void> {
    ...
    try {
      ...
      if (validationResult && typeof validationResult.isValid === 'boolean') {
        this.addResult('Schema Validation Integration', 'PASS', 
          `Schema validation completed. Valid: ${validationResult.isValid}`, 
          duration, validationResult);
      } else {
        this.addResult('Schema Validation Integration', 'FAIL', 
          'Schema validation returned invalid response', duration);
      }
      
    } catch (error) {
      this.addResult('Schema Validation Integration', 'FAIL', 
        `Schema validation failed: ${error instanceof Error ? error.message : 'Unknown error'}`, 0);
    }
  }
  ...
  private async testServiceHealthMonitoring(): Promise<void> {
    ...
    try {
      ...
      if (serviceHealth && serviceHealth.services && Array.isArray(serviceHealth.services)) {
        this.addResult('Service Health Monitoring', 'PASS', 
        ...
        this.addResult('Service Health Monitoring', 'FAIL', 
          'Service monitoring returned invalid response', duration);
      }
      
    } catch (error) {
      this.addResult('Service Health Monitoring', 'FAIL', 
        `Service monitoring failed: ${error instanceof Error ? error.message : 'Unknown error'}`, 0);
    }
  }
  ...
  private async testPerformanceMetricsCollection(): Promise<void> {
    ...
    try {
      ...
      if (performanceMetrics && performanceMetrics.memory && performanceMetrics.uptime !== undefined) {
        ...
        this.addResult('Performance Metrics Collection', 'FAIL', 
          'Performance metrics returned invalid response', duration);
      }
      
    } catch (error) {
      this.addResult('Performance Metrics Collection', 'FAIL', 
        `Performance metrics failed: ${error instanceof Error ? error.message : 'Unknown error'}`, 0);
    }
  }
  ...
  private async testDatabaseMonitoring(): Promise<void> {
    ...
    try {
      ...
      if (dbHealth && dbHealth.status && dbHealth.connections && dbHealth.performance) {
        this.addResult('Database Monitoring', 'PASS', 
        ...
        this.addResult('Database Monitoring', 'FAIL', 
          'Database monitoring returned invalid response', duration);
      }
      
    } catch (error) {
      this.addResult('Database Monitoring', 'FAIL', 
        `Database monitoring failed: ${error instanceof Error ? error.message : 'Unknown error'}`, 0);
    }
  }
  ...
  private async testUnifiedMonitorIntegration(): Promise<void> {
    ...
    try {
      ...
      if (systemStatus && systemStatus.health && systemStatus.services && systemStatus.database) {
        this.addResult('Unified Monitor Integration', 'PASS', 
        ...
        this.addResult('Unified Monitor Integration', 'FAIL', 
          'Unified monitor returned invalid response', duration);
      }
      
    } catch (error) {
      this.addResult('Unified Monitor Integration', 'FAIL', 
        `Unified monitor failed: ${error instanceof Error ? error.message : 'Unknown error'}`, 0);
    }
  }
  ...
  private async testComponentIntegration(): Promise<void> {
    ...
    try {
      ...
      if (allComponentsAvailable) {
        this.addResult('Component Integration', 'PASS', 
          'All monitoring components properly integrated and available', 
          duration, components);
      } else {
        this.addResult('Component Integration', 'FAIL', 
          'Some monitoring components are not available', duration, components);
      }
      
    } catch (error) {
      this.addResult('Component Integration', 'FAIL', 
        `Component integration test failed: ${error instanceof Error ? error.message : 'Unknown error'}`, 0);
    }
  }
  ...
  private displayResults(): void {
    ...
    console.log(`  ✅ All health check endpoints functional: ${this.hasPassingTest('Health Check Endpoints') ? 'PASS' : 'FAIL'}`);
    console.log(`  ✅ Schema validation integrated: ${this.hasPassingTest('Schema Validation Integration') ? 'PASS' : 'FAIL'}`);
    console.log(`  ✅ Service health monitoring active: ${this.hasPassingTest('Service Health Monitoring') ? 'PASS' : 'FAIL'}`);
    console.log(`  ✅ Performance metrics collection active: ${this.hasPassingTest('Performance Metrics Collection') ? 'PASS' : 'FAIL'}`);
    console.log(`  ✅ Database monitoring functional: ${this.hasPassingTest('Database Monitoring') ? 'PASS' : 'FAIL'}`);
    console.log(`  ✅ Unified monitoring integration: ${this.hasPassingTest('Unified Monitor Integration') ? 'PASS' : 'FAIL'}`);
