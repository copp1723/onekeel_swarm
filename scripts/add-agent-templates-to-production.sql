-- Add agent_templates to production database
-- This adds the preconfigured Sales, Service, and Marketing agents
...
-- Create indexes
CREATE INDEX IF NOT EXISTS "agent_templates_name_idx" ON "agent_templates" USING btree ("name");
CREATE INDEX IF NOT EXISTS "agent_templates_type_idx" ON "agent_templates" USING btree ("type");
CREATE INDEX IF NOT EXISTS "agent_templates_category_idx" ON "agent_templates" USING btree ("category");
CREATE INDEX IF NOT EXISTS "agent_templates_is_default_idx" ON "agent_templates" USING btree ("is_default");
...
-- Verify the agent templates were created
SELECT 
  name, 
  category, 
  is_default,
