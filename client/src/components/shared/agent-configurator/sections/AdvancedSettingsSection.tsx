...
export function AdvancedSettingsSection({
  ...
  const selectedAgentType = AGENT_TYPES.find(
          ...
          <div className='space-y-2'>
            <div className='flex flex-wrap gap-2'>
              {selectedAgentType.capabilities.email && (
                <Badge
                  variant='outline'
                  className='flex items-center space-x-1 py-1.5'
                >
                  <span>📧</span>
                  <span>Email</span>
                </Badge>
        ...
        <div className='bg-gray-50 p-3 rounded-lg flex items-start space-x-2'>
          ...
          <div>
            <p className='text-sm text-gray-700'>
              This agent uses smart AI technology that automatically selects the
              best model for each task.
            </p>
            <p className='text-xs text-gray-500 mt-1'>
              We've configured optimal settings so you don't have to worry about
