      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-gray-600'>
            Master coordinator managing all AI agents and campaigns
          </p>
        </div>
          ...
          <div className='space-y-4'>
            {managedAgents.length === 0 ? (
              <div className='text-center py-8 text-gray-500'>
                ...
                <p className='text-sm'>
                  Create some agents to see coordination metrics
                </p>
              </div>
            ) : (
                  ...
                  >
                    <div className='flex items-center space-x-4'>
                      <div className='text-2xl'>
                        {getAgentTypeIcon(managedAgent.type)}
                      </div>
                      <div>
                        <h4 className='font-medium'>{managedAgent.name}</h4>
                        <p className='text-sm text-gray-600 capitalize'>
                          {managedAgent.type} Agent
                        </p>
                      </div>
                    </div>
                    ...
                    <div className='flex items-center space-x-4'>
                      <div className='text-right'>
                        ...
                        <p className={`font-medium ${getPerformanceColor(85)}`}>
                          85%
                        </p>
                      </div>
        ...
        <CardContent>
          <div className='space-y-3'>
            {[
              {
                time: '2 minutes ago',
                action: 'Optimized email campaign timing for better engagement',
                type: 'optimization',
              },
              {
                time: '15 minutes ago',
                action: 'Redistributed chat load from Agent-3 to Agent-1',
                type: 'balancing',
              },
              {
                time: '1 hour ago',
                action:
                  'Triggered SMS follow-up sequence for email non-responders',
                type: 'coordination',
              },
              {
                time: '2 hours ago',
                action:
                  'Paused underperforming campaign and reallocated budget',
                type: 'optimization',
              },
              {
                time: '3 hours ago',
                action: 'Escalated complex customer query to human agent',
                type: 'escalation',
              },
            ].map((decision, index) => (
              <div
              ...
              >
                <div className='flex-shrink-0 mt-1'>
                  ...
                  {decision.type === 'balancing' && (
                    <Users className='h-4 w-4 text-blue-500' />
                  )}
                  {decision.type === 'coordination' && (
