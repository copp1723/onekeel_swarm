    ...
    (acceptedFiles: File[]) => {
      ...
      Papa.parse(file, {
        ...
        complete: (results: Papa.ParseResult<any>) => {
          ...
          if (!foundEmail) {
            setCsvError(
              'Required column "Email" not found. Please ensure your CSV has a column with email addresses.'
            );
            return;
          }
          ...
          if (!foundFirstName) {
            setCsvError(
              'Required column "First Name" not found. Please ensure your CSV has a column with first names.'
            );
            return;
          }
  ...
  const generateEmailTemplates = async () => {
    try {
      ...
      const benefits =
        ...
        Array.isArray(campaignData.offer.keyBenefits)
          ? campaignData.offer.keyBenefits
      ...
      const response = await fetch('/api/agents/email/generate-sequence', {
        ...
        body: JSON.stringify({
          ...
          context:
            campaignData.context || 'Reaching out to potential customers',
          product: campaignData.offer?.product || 'our product',
          benefits: benefits,
          priceAngle:
            campaignData.offer?.pricing || 'Competitive pricing available',
      ...
      const templates = sequence.map(
        (
          email: { subject: string; body: string; order?: number },
          index: number
        ) => ({
          id: `template-${index + 1}`,
      ...
      console.error(
        'Error generating AI templates, falling back to local:',
        error
      );
            ...
            <div className='space-y-4'>
              ...
              <div>
                ...
                <p className='text-xs text-gray-500 mt-1'>
                  Provide comprehensive context including target audience, value
                  proposition, objection handling, and communication strategy.
                  This guides the AI to generate highly relevant and effective
                  messaging.
                </p>
              </div>
            </div>
            ...
            <div className='space-y-4'>
              <div className='bg-blue-50 p-4 rounded-lg'>
                ...
                <p className='text-sm text-blue-700'>
                  Upload a CSV file with your contact list. The file must
                  include "First Name" and "Email" columns.
                </p>
              </div>
                ...
                <div>
                  ...
                  <div className='mt-4 p-3 bg-gray-50 rounded-lg'>
                    ...
                    <ul className='text-xs text-gray-600 space-y-1'>
                      <li>
                        • Must include "First Name" and "Email" columns
                        (auto-detected)
                      </li>
                      <li>• Maximum 10 columns will be imported</li>
                      <li>
                        • Common column variations are supported (e.g.,
          ...
          return (
            <div className='space-y-4'>
              <div className='bg-green-50 p-4 rounded-lg'>
                ...
                <p className='text-sm text-green-700'>
                  Provide details about your offer so AI can create compelling
                  email templates.
                </p>
              </div>
          ...
          return (
            <div className='space-y-4'>
              <div className='bg-purple-50 p-4 rounded-lg'>
                ...
                <p className='text-sm text-purple-700'>
                  Generate email templates automatically based on your offer
                  details and campaign goals.
                </p>
              </div>
                ...
                <div className='space-y-4'>
                  <div className='text-center py-8'>
                    ...
                    >
                      ...
                      Generate {campaignData.schedule.totalEmails} Email
                      Templates
                    </Button>
                  </div>
                    ...
                    <div className='flex items-start space-x-2'>
                      ...
                      <div className='text-sm'>
                        ...
                        <p className='text-blue-700 mt-1'>
                          AI will create {campaignData.schedule.totalEmails}{' '}
                          progressive emails based on your offer, each with
                          unique subject lines and escalating urgency. When a
                          lead replies to ANY email, the remaining templates are
                          cancelled and AI takes over for personalized
                          conversation.
                        </p>
                      </div>
                    </div>
                ...
                <div className='space-y-4'>
                  <div className='flex items-center justify-between'>
                    <h4 className='font-medium'>
                      Generated Templates ({campaignData.templates.length})
                    </h4>
                    <Button
                      variant='outline'
                      size='sm'
                              ...
                              <div className='flex items-center justify-between'>
                                ...
                                <div className='flex items-center gap-2'>
                                  <Badge variant='outline'>
                                    Day{' '}
                                    {index *
                                      campaignData.schedule.daysBetweenEmails +
                                      1}
                                  </Badge>
                                  <Button
                                    variant='ghost'
            ...
            <div className='space-y-4'>
              <div className='bg-orange-50 p-4 rounded-lg'>
                ...
                <p className='text-sm text-orange-700'>
                  Configure your email sequence timing. If a lead replies, the
                  AI takes over with personalized conversations.
                </p>
              </div>
              <div className='space-y-4'>
                <div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                      setCampaignData(prev => ({
                        ...
                        schedule: {
                          ...prev.schedule,
                          totalEmails: parseInt(e.target.value) || 1,
                        },
                      }))
                    }
                    className='mt-1'
                  ...
                  />
                  <p className='text-xs text-gray-500 mt-1'>
                    Number of templated emails to send (if no response)
                  </p>
                </div>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                      setCampaignData(prev => ({
                        ...
                        schedule: {
                          ...prev.schedule,
                          daysBetweenEmails: parseInt(e.target.value) || 1,
                        },
                      }))
                    }
                    className='mt-1'
                  ...
                  />
                  <p className='text-xs text-gray-500 mt-1'>
                    Wait time between each templated email
                  </p>
                </div>
                <div className='bg-blue-50 p-3 rounded-lg'>
                  <div className='flex items-start space-x-2'>
                    ...
                    <div className='text-sm'>
                      ...
                      <p className='text-blue-700 mt-1'>
                        When a lead replies to any email, the remaining
                        templated emails are cancelled. The AI agent takes over
                        for personalized back-and-forth conversation until
                        handover.
                      </p>
                    </div>
                  </div>
          ...
          return (
            <div className='space-y-4'>
              <div className='bg-blue-50 p-4 rounded-lg'>
                ...
                <p className='text-sm text-blue-700'>
                  Define when the AI should hand over conversations to human
                  agents based on lead behavior and intent.
                </p>
              </div>
              ...
              <div className='space-y-4'>
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                      setCampaignData(prev => ({
                        ...
                        handoverRules: {
                          ...prev.handoverRules,
                          qualificationScore: parseInt(e.target.value) || 0,
                        },
                      }))
                    }
                    className='mt-1'
                  />
                  <p className='text-xs text-gray-500 mt-1'>
                    Hand over when lead reaches this qualification score
                  </p>
                </div>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                      setCampaignData(prev => ({
                        ...
                        handoverRules: {
                          ...prev.handoverRules,
                          conversationLength: parseInt(e.target.value) || 10,
                        },
                      }))
                    }
                    className='mt-1'
                  />
                  <p className='text-xs text-gray-500 mt-1'>
                    Hand over after this many messages
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className='text-xs text-gray-500 mt-1'>
                    Hand over after this many minutes of conversation
                  </p>
                </div>
                ...
                <div>
                  ...
                  />
                  <p className='text-xs text-gray-500 mt-1'>
                    Comma-separated phrases indicating purchase intent
                  </p>
                </div>
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) =>
                      setCampaignData(prev => ({
                        ...
                        handoverRules: {
                          ...prev.handoverRules,
                          escalationPhrases: e.target.value
                            .split(',')
                            .map(s => s.trim())
                            .filter(s => s),
                        },
                  ...
                  />
                  <p className='text-xs text-gray-500 mt-1'>
                    Comma-separated phrases requesting human assistance
                  </p>
                </div>
                ...
                <div>
                  ...
                  <div className='space-y-2 mt-1'>
                    {campaignData.handoverRules.handoverRecipients.map(
                      (
                        ...
                        <div key={index} className='flex gap-2'>
                          <Input
                            ...
                            onChange={(
                              ...
                              setCampaignData(prev => ({
                                ...
                                handoverRules: {
                                  ...prev.handoverRules,
                                  handoverRecipients: newRecipients,
                                },
                              }));
                            }}
                          />
                          ...
                          <Button
                            ...
                            onClick={() => {
                              const newRecipients =
                                campaignData.handoverRules.handoverRecipients.filter(
                                  (_, i) => i !== index
                                );
                              setCampaignData(prev => ({
                                ...prev,
                      ...
                      onClick={() => {
                        setCampaignData(prev => ({
                          ...
                          handoverRules: {
                            ...prev.handoverRules,
                            handoverRecipients: [
                              ...prev.handoverRules.handoverRecipients,
                              { name: '', email: '' },
                            ],
                          },
                        }));
                  ...
                  <p className='text-xs text-gray-500 mt-1'>
                    People to notify when handover occurs
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className='space-y-4'>
              ...
              <div className='space-y-3'>
                ...
                <div className='p-3 bg-gray-50 rounded'>
                  ...
                  <p className='text-sm'>
                    {agents.find(a => a.id === campaignData.agentId)?.name ||
                      'No agent selected'}
                  </p>
                </div>
                <div className='p-3 bg-gray-50 rounded'>
                  ...
                  <div className='text-sm space-y-1'>
                    <p>
                      ...
                      {campaignData.offer.product || 'Not set'}
                    </p>
                    <p>
                      <span className='font-medium'>Pricing:</span>{' '}
                      {campaignData.offer.pricing || 'Not set'}
                    </p>
                    <p>
                      <span className='font-medium'>CTA:</span>{' '}
                      {campaignData.offer.cta.primary || 'Not set'}
                    </p>
                  </div>
                </div>
                <div className='p-3 bg-gray-50 rounded'>
                  ...
                  <div className='text-sm'>
                    {campaignData.templates.length > 0 ? (
                      <div className='space-y-1'>
                        <p>
                          {campaignData.templates.length} templates generated
                        </p>
                        <div className='text-xs text-gray-500'>
                          {campaignData.templates.map(
                            (t: EmailTemplate, i: number) => (
                              <div key={i}>
                                Email {i + 1}: {t.subject}
                              </div>
                            )
                ...
                <div className='p-3 bg-gray-50 rounded'>
                  ...
                  <p className='text-sm'>
                    {campaignData.schedule.totalEmails} emails,{' '}
                    {campaignData.schedule.daysBetweenEmails} days apart
                  </p>
                  <p className='text-xs text-gray-500 mt-1'>
                ...
                <div className='p-3 bg-gray-50 rounded'>
                  ...
                  <p className='text-sm'>
                    {campaignData.schedule.startDate || 'Not set'}
                  </p>
                </div>
              </div>
            </div>
