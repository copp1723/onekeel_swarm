    ...
    <div className='space-y-4'>
      <div className='bg-orange-50 p-4 rounded-lg'>
        ...
        <p className='text-sm text-orange-700'>
          Configure your email sequence timing. If a lead replies, the AI takes
          over with personalized conversations.
        </p>
      </div>
      <div className='space-y-4'>
        <div>
          ...
          <div className='flex items-start space-x-2'>
            ...
            <div className='text-sm'>
              ...
              <p className='text-blue-700 mt-1'>
                When a lead replies to any email, the remaining templated emails
                are cancelled. The AI agent takes over for personalized
                back-and-forth conversation until handover.
              </p>
            </div>
          </div>
        </div>
