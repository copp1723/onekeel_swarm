    ...
    <div className='space-y-4'>
      <div className='bg-blue-50 p-4 rounded-lg'>
        ...
        <p className='text-sm text-blue-700'>
          Upload a CSV file with your contact list. The file must include "First
        ...
        <div>
          ...
          <div className='mt-4 p-3 bg-gray-50 rounded-lg'>
            ...
            <ul className='text-xs text-gray-600 space-y-1'>
              <li>
                • Must include "First Name" and "Email" columns (auto-detected)
              </li>
              <li>• Maximum 10 columns will be imported</li>
              <li>
                • Common column variations are supported (e.g., "firstname",
                "email address")
              </li>
