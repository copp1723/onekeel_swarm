...
const SAMPLE_MESSAGES: Record<string, Message[]> = {
  '1': [
    ...
    },
    {
      ...
      direction: 'inbound',
      content:
        "I'd like to learn more about your enterprise pricing options. Can you send me a detailed breakdown?",
  ...
  '2': [
    {
      ...
      direction: 'inbound',
      content:
        "Hi there, I'm looking to get a demo of your analytics platform. I've heard good things about it from colleagues.",
    ...
    },
    {
      ...
      direction: 'outbound',
      content:
        "Hello Michael! I'm Emma from the support team. I'd be happy to give you a demo of our analytics platform. When would be a good time for you?",
    ...
    },
    {
      ...
      direction: 'outbound',
      content:
        "That works perfectly! I'll send you a calendar invite with the meeting link shortly. In the meantime, is there any specific feature you're most interested in seeing?",
    ...
    },
    {
      ...
      direction: 'inbound',
      content:
        "Great! I'm particularly interested in the custom dashboards and report scheduling features. Also curious about your data integration capabilities.",
      createdAt: new Date(Date.now() - 4 * 60 * 60 * 1000).toISOString(),
    },
    {
      id: '206',
      direction: 'outbound',
      content:
        "Perfect! I'll make sure to highlight those features during our demo. You'll be pleased to know that we have extensive data integration options and our custom dashboards are highly flexible.\n\nI've just sent the calendar invite to your email. Looking forward to speaking with you at 3pm PST today!",
    ...
    },
    {
      ...
      direction: 'inbound',
      content:
        "Thanks for the demo! I'm impressed with the analytics dashboard. When can we schedule a follow-up call?",
  ...
  '3': [
    {
      ...
      direction: 'outbound',
      content:
        "Hi Sarah, this is Ryan from OneKeel! We've just released our latest update with the refreshed UI you requested. Would love to hear your thoughts once you've had a chance to try it out!",
    ...
    },
    {
      ...
      direction: 'inbound',
      content:
        "Hi Ryan! Thanks for letting me know. I'll check it out today and get back to you.",
    ...
    },
    {
      ...
      direction: 'inbound',
      content:
        'Just logged in to check the new UI. Looks much cleaner! The navigation is definitely more intuitive.',
      createdAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
    },
    {
      id: '304',
      direction: 'outbound',
      content:
        "That's great to hear, Sarah! I'm glad you like the improved navigation. We put a lot of effort into making it more intuitive based on customer feedback like yours. Is there anything specific that stands out to you as particularly improved?",
    ...
    },
    {
      ...
      direction: 'inbound',
      content:
        'The dashboard layout is much better - I can see all my key metrics without scrolling now. And the dark mode option is a nice touch!',
      createdAt: new Date(Date.now() - 1.5 * 24 * 60 * 60 * 1000).toISOString(),
    },
    {
      id: '306',
      direction: 'outbound',
      content:
        "I'm really happy to hear that! The dashboard layout was redesigned specifically to improve visibility of key metrics without scrolling. And the dark mode has been one of our most requested features!\n\nIs there anything else you'd like to see in future updates?",
    ...
    },
    {
      ...
      direction: 'inbound',
      content:
        'I got the latest update. The new UI is much better! Just one question about the export feature.',
      createdAt: new Date(Date.now() - 1 * 24 * 60 * 60 * 1000).toISOString(),
    },
  ],
  ...
  '4': [
    {
      ...
      direction: 'inbound',
      content:
        "Hello, I'd like to get more information about your enterprise solution. Our company is looking to upgrade our current system.",
  ...
  '5': [
    {
      ...
      direction: 'inbound',
      content:
        'We need to expand our current plan. Can you help me understand the upgrade options?',
      createdAt: new Date(Date.now() - 4 * 60 * 60 * 1000).toISOString(),
      metadata: {
  ...
  '6': [
    {
      ...
      direction: 'inbound',
      content:
        "Hi, I'm working on integrating your API with our application. I have a few technical questions.",
      createdAt: new Date(Date.now() - 2 * 24 * 60 * 60 * 1000).toISOString(),
    },
...
export function ConversationThread({
  ...
  const renderMessage = (message: Message) => {
    ...
    return (
      ...
      >
        <div
          className={`flex ${isInbound ? 'flex-row' : 'flex-row-reverse'} max-w-[85%]`}
        >
          <Avatar
            className={`h-8 w-8 flex-shrink-0 ${isInbound ? 'mt-1' : 'mt-1'}`}
          >
            <AvatarFallback
              className={
                isInbound
          ...
          <div className={`mx-2 ${isInbound ? 'text-left' : 'text-right'}`}>
            ...
            <div
              className={`${isInbound ? 'bg-white border border-gray-200' : isAI ? 'bg-purple-50 border border-purple-100' : 'bg-blue-50 border border-blue-100'} rounded-lg shadow-sm`}
            >
              <div className='p-3'>
                <div
