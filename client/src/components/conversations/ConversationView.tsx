      ...
      <div className='border-b p-4'>
        <div className='flex items-center justify-between'>
          <div className='flex items-center space-x-3'>
            <Avatar>
              <AvatarFallback>
                {getLeadInitials(conversation.lead)}
              </AvatarFallback>
            </Avatar>
            <div>
              <h3 className='font-semibold'>
                {getLeadName(conversation.lead)}
              </h3>
          ...
          <div className='flex items-center space-x-2'>
            ...
            <DropdownMenu>
              ...
              <DropdownMenuContent align='end'>
                ...
                <DropdownMenuItem
                  onClick={() =>
                    (window.location.href = `/leads/${conversation.leadId}`)
                  }
                >
      ...
      <ScrollArea className='flex-1 p-4'>
        <div className='space-y-4'>
          {conversation.messages.map((msg, index) => (
            ...
            >
              <div
                className={`flex items-start space-x-2 max-w-[70%] ${msg.role === 'user' ? 'flex-row-reverse space-x-reverse' : ''}`}
              >
