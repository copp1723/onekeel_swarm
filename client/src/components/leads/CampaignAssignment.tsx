...
export function CampaignAssignment({
  ...
  return (
    <div className='space-y-6'>
                  ...
                  {activeCampaigns.map(campaign => (
                    <SelectItem key={campaign.id} value={campaign.id}>
                      <div className='flex items-center justify-between w-full'>
                        ...
                        <Badge
                          className={getCampaignStatusBadge(campaign.status)}
                          variant='secondary'
                        >
                          {campaign.status}
                        </Badge>
              ...
              <div className='border rounded-lg p-3 bg-gray-50'>
                ...
                <div className='text-sm'>
                  <div className='flex items-center justify-between'>
                    ...
                    <Badge
                      className={getCampaignStatusBadge(
                  ...
                  <Checkbox
                    ...
                    onCheckedChange={checked =>
                      setAssignmentOptions(prev => ({
                        ...prev,
                        startImmediately: checked as boolean,
                      }))
                    }
                  />
                  ...
                  <div className='flex items-center space-x-2'>
                    <Checkbox
                      ...
                      onCheckedChange={checked =>
                        setAssignmentOptions(prev => ({
                          ...prev,
                          preserveExistingCampaigns: checked as boolean,
                        }))
                      }
                    />
      ...
      {/* Warnings */}
      {leadsWithExistingCampaigns.length > 0 &&
        !assignmentOptions.preserveExistingCampaigns && (
          <Alert>
            <AlertCircle className='h-4 w-4' />
            <AlertDescription>
              {leadsWithExistingCampaigns.length} lead(s) are already assigned
              to other campaigns. They will be moved to the new campaign.
            </AlertDescription>
          </Alert>
        )}
          ...
          <div className='flex items-center justify-between'>
            ...
            <div className='flex items-center space-x-3'>
              ...
              <Button
                ...
                disabled={
                  loading || selectedLeads.length === 0 || !selectedCampaign
                }
              >
                {loading ? (
