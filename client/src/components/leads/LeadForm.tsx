...
export function LeadForm({
    ...
    if (lead) {
      ...
      if (lead.metadata) {
        const customFieldsArray = Object.entries(lead.metadata)
          .filter(
            ([key]) => !['createdAt', 'updatedAt', 'source'].includes(key)
          )
  ...
  const validateForm = (): boolean => {
    ...
    if (
      formData.qualificationScore &&
      (formData.qualificationScore < 0 || formData.qualificationScore > 100)
    ) {
    ...
    if (
      ...
      (formData.creditScore < 300 || formData.creditScore > 850)
    ) {
          ...
          <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={value =>
                  handleInputChange('assignedChannel', value || undefined)
                }
              >
                <SelectTrigger>
          ...
          {campaigns.length > 0 && (
            <div>
              ...
              <Select
                ...
                onValueChange={value =>
                  handleInputChange('campaignId', value || undefined)
                }
              >
                <SelectTrigger>
