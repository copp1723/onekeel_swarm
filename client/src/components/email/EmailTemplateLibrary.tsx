                ...
                >
                  <CardContent className='p-4'>
                    <div className='flex items-start justify-between mb-2'>
                      ...
                      <Badge
                        variant='outline'
                        className={`text-${categoryColors[template.category]}-600`}
                      >
              ...
              <TabsContent value='html'>
                <div>
                  ...
                  <p className='text-xs text-gray-500 mt-1'>
                    Use variables like {`{{firstName}}`}, {`{{lastName}}`},{' '}
                    {`{{email}}`}, {`{{companyName}}`}
                  </p>
                </div>
              </TabsContent>
                ...
                <div>
                  ...
                  <Button
                    ...
                    onClick={() =>
                      setFormData({
                        ...formData,
                        plainText: stripHtml(formData.content),
                      })
                    }
                  >
                    Generate from HTML
