...
export function AgentConfigurator({
  ...
  const handleInstructionChange = (
    ...
    setFormData(prev => ({
      ...
      instructions: {
        ...prev.instructions,
        [type]: prev.instructions[type].map((item, i) =>
          i === index ? value : item
        ),
      },
    }));
    ...
    <form onSubmit={handleSubmit} className='space-y-6'>
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure an AI agent with specific goals, instructions, and
            expertise
          </CardDescription>
        </CardHeader>
        <CardContent className='space-y-6'>
          ...
          <div className='space-y-2'>
            ...
            <Textarea
              ...
              onChange={(e: React.ChangeEvent<HTMLTextAreaElement>) =>
                handleInputChange('endGoal', e.target.value)
              }
            ...
            <p className='text-sm text-gray-500'>
              Define the specific outcome this agent should achieve through
              email conversations
            </p>
          </div>
          ...
          <div className='space-y-2'>
            ...
            <div className='mb-3'>
              ...
              <div className='flex flex-wrap gap-2'>
                {[
                  'Personalize emails with customer name',
                      ...
                      if (!formData.instructions.dos.includes(suggestion)) {
                        setFormData(prev => ({
                          ...
                          instructions: {
                            ...prev.instructions,
                            dos: [
                              ...prev.instructions.dos.filter(d => d),
                              suggestion,
                            ],
                          },
                        }));
              ...
              {formData.instructions.dos.map((instruction, index) => (
                <div key={index} className='flex items-center space-x-2'>
                  <Input
                    value={instruction}
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                      handleInstructionChange('dos', index, e.target.value)
                    }
                      ...
                      if (!formData.instructions.donts.includes(suggestion)) {
                        setFormData(prev => ({
                          ...
                          instructions: {
                            ...prev.instructions,
                            donts: [
                              ...prev.instructions.donts.filter(d => d),
                              suggestion,
                            ],
                          },
                        }));
              ...
              {formData.instructions.donts.map((instruction, index) => (
                <div key={index} className='flex items-center space-x-2'>
                  <Input
                    value={instruction}
                    onChange={(e: React.ChangeEvent<HTMLInputElement>) =>
                      handleInstructionChange('donts', index, e.target.value)
                    }
                    ...
                    onClick={() => {
                      if (!formData.domainExpertise.includes(suggestion)) {
                        setFormData(prev => ({
                          ...prev,
                          domainExpertise: [
                            ...prev.domainExpertise.filter(e => e),
                            suggestion,
                          ],
                        }));
                      }
          ...
          <div className='border-t pt-6'>
              ...
              <div className='flex items-center space-x-2'>
                <Switch
                  ...
                  onCheckedChange={checked =>
                    handleSettingsChange('enableAutoResponse', checked)
                  }
                />
                ...
                <div className='grid grid-cols-3 gap-4'>
                  ...
                  <div className='space-y-2'>
                    ...
                    <Select
                      ...
                      onValueChange={value =>
                        handleWorkingHoursChange('timezone', value)
                      }
                    >
                      <SelectTrigger>
                        <SelectValue />
            ...
            <div className='border-t pt-4 space-y-4'>
              ...
              <p className='text-sm text-gray-500'>
                Define phrases that indicate when to hand over the conversation
                to a human agent
              </p>
              ...
              <div className='space-y-4'>
                <div className='space-y-2'>
                  ...
                  <div className='flex flex-wrap gap-2 mb-2'>
                    {formData.settings.handoverRules.buyingSignals.map(
                      (signal, idx) => (
                              ...
                              setFormData(prev => ({
                                ...
                                settings: {
                                  ...
                                  handoverRules: {
                                    ...
                                    buyingSignals:
                                      prev.settings.handoverRules.buyingSignals.filter(
                                        (_, i) => i !== idx
                                      ),
                                  },
                                },
                          ...
                          setFormData(prev => ({
                            ...
                            settings: {
                              ...
                              handoverRules: {
                                ...prev.settings.handoverRules,
                                buyingSignals: [
                                  ...prev.settings.handoverRules.buyingSignals,
                                  input.value.trim(),
                                ],
                              },
                            },
                ...
                <div className='space-y-2'>
                  ...
                  <div className='flex flex-wrap gap-2 mb-2'>
                    {formData.settings.handoverRules.escalationPhrases.map(
                      (phrase, idx) => (
                        <Badge key={idx} variant='secondary' className='pr-1'>
                          {phrase}
                          <Button
                              ...
                              setFormData(prev => ({
                                ...
                                settings: {
                                  ...
                                  handoverRules: {
                                    ...prev.settings.handoverRules,
                                    escalationPhrases:
                                      prev.settings.handoverRules.escalationPhrases.filter(
                                        (_, i) => i !== idx
                                      ),
                                  },
                                },
              ...
              <div className='bg-blue-50 border border-blue-200 rounded-lg p-3'>
                <div className='flex items-start space-x-2'>
                  ...
                  <p className='text-sm text-blue-800'>
                    When these phrases are detected, the agent will stop the
                    campaign and notify the human team for immediate follow-up.
                  </p>
                </div>
              </div>
            </div>
