      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-gray-600'>
            Configure AI agents for intelligent email campaigns
          </p>
        </div>
                ...
                <div className='text-2xl font-bold'>
                  {campaigns.length > 0
                    ? Math.round(
                        campaigns.reduce(
                          (acc, c) =>
                            acc + ((c.stats.opened / c.stats.sent) * 100 || 0),
                          0
                        ) / campaigns.length
                      )
                    : 0}
          ...
          <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Latest email campaign activity
                </CardDescription>
              </CardHeader>
              <CardContent>
                      ...
                      <div className='flex items-center space-x-3'>
                        ...
                        <div>
                          ...
                          <p className='text-xs text-gray-500'>
                            {agents.find(a => a.id === campaign.agentId)
                              ?.name || 'Unknown Agent'}
                          </p>
                        </div>
                      </div>
                ...
                <div className='space-y-4'>
                  {agents
                    ...
                    .map(agent => {
                      ...
                      const totalSent = agentCampaigns.reduce(
                        (acc, c) => acc + c.stats.sent,
                        0
                      );
                      const totalOpened = agentCampaigns.reduce(
                        (acc, c) => acc + c.stats.opened,
                        0
                      );
                      const openRate =
                        totalSent > 0
                      ...
                      <div>
                        ...
                        <p className='text-sm text-gray-600'>
                          {typeof agent.personality === 'object'
                            ? (agent.personality as any)?.style
                ...
                <Card className='col-span-2'>
                  <CardContent className='text-center py-12'>
                    ...
                    <p className='text-gray-500 mb-6'>
                      Create your first AI email agent to get started.
                    </p>
                    <Button
                      onClick={() => {
                        setSelectedAgent(null);
