...
export function CampaignAnalytics({
  ...
  const calculateAnalytics = () => {
    ...
    const avgReplyRate =
      stats.sent > 0 ? (stats.replied / stats.sent) * 100 : 0;
                ...
                return (
                  ...
                  >
                    ...
                    <div className='text-right'>
                      <p
                        className={`text-lg font-bold ${getStatusColor(openRate)}`}
                      >
                        {openRate}%
                      </p>
            ...
            <div className='space-y-4'>
              {analytics.topPerformingAgents.map(agent => (
                ...
                >
                  ...
                  <div className='text-right'>
                    <p
                      className={`text-lg font-bold ${getStatusColor(agent.openRate)}`}
                    >
              ...
              <div className='flex items-start space-x-3 p-4 bg-yellow-50 rounded-lg'>
                ...
                <div>
                  <p className='font-medium text-yellow-900'>
                    Low Open Rates Detected
                  </p>
                  <p className='text-sm text-yellow-800 mt-1'>
                    Your average open rate is below industry standards. Consider
                    improving subject lines, sender reputation, or sending
                    times.
                  </p>
                </div>
              </div>
              ...
              <div className='flex items-start space-x-3 p-4 bg-blue-50 rounded-lg'>
                ...
                <div>
                  ...
                  <p className='text-sm text-blue-800 mt-1'>
                    Good open rates but low clicks suggest your content needs
                    stronger CTAs. Make links more prominent and compelling.
                  </p>
                </div>
              </div>
            )}
              ...
              <div className='flex items-start space-x-3 p-4 bg-green-50 rounded-lg'>
                ...
                <div>
                  ...
                  <p className='text-sm text-green-800 mt-1'>
                    Your campaigns are generating conversations. Keep up the
                    personalized approach and relevant content.
                  </p>
                </div>
              </div>
            )}
