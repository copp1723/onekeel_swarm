...
import { Mail, Plus, Play, Pause, Edit, Trash2, Search } from 'lucide-react';
  ...
  const handleCampaignToggle = async (
    ...
    try {
      const response = await fetch(
        `/api/email/campaigns/${campaignId}/status`,
        {
          method: 'PUT',
          headers: { 'Content-Type': 'application/json' },
                ...
                <div className='space-y-2 mb-4'>
                  <div className='flex items-center justify-between text-sm'>
                    ...
                    <span className='font-medium'>
                      {campaign.templates?.length || 0} active
                    </span>
                  </div>
                  <div className='flex items-center justify-between text-sm'>
                  ...
                  <div className='flex items-center space-x-2'>
                    {campaign.status === 'draft' ? (
                      <Button
                        size='sm'
                        onClick={() =>
                          handleCampaignToggle(campaign.id, campaign.status)
                        }
                      >
