    ...
    <Card>
      ...
      <CardContent className='space-y-6'>
        ...
        <div className='space-y-4'>
          ...
          {'conversationMode' in settings &&
            settings.conversationMode !== 'template' && (
            ...
            <div className='border-t pt-4 space-y-4'>
              ...
              <div className='space-y-2'>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value='first_reply'>
                      Lead replies to any email
                    </SelectItem>
                    <SelectItem value='buying_signals'>
        ...
        <div className='border-t pt-4 space-y-4'>
          ...
          <div className='space-y-2'>
            ...
            <Textarea
              ...
              onChange={e => updateSettings({ handoverGoal: e.target.value })}
