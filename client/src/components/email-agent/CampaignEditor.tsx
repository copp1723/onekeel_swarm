    ...
    <form onSubmit={handleSubmit} className='space-y-6'>
          ...
          {selectedAgent && (
            <div className='bg-blue-50 border border-blue-200 rounded-lg p-4'>
              ...
              <div className='space-y-1 text-sm text-blue-800'>
                <p>
                  <strong>End Goal:</strong> {selectedAgent.endGoal}
                </p>
                <p>
                  <strong>Personality:</strong>{' '}
                  {selectedAgent.personality?.style || 'Not set'} •{' '}
                  {selectedAgent.tone} tone
                </p>
                <div className='flex items-start'>
                  <strong className='mr-2'>Expertise:</strong>
                  <div className='flex flex-wrap gap-1'>
                    {selectedAgent.domainExpertise.map(
                      (expertise: string, idx: number) => (
                        <Badge
                          key={idx}
                          variant='secondary'
                          className='text-xs'
              ...
              <div className='space-y-2'>
                {selectedSchedule.attempts.map((attempt: any, idx: number) => (
                  <div key={idx} className='flex items-center text-sm'>
                    ...
                    <span>
                      Attempt {idx + 1}: After {attempt.delayDays} days,{' '}
                      {attempt.delayHours} hours
                    </span>
                  </div>
                ))}
              </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Fine-tune campaign behavior</CardDescription>
        </CardHeader>
                        ...
                        onClick={() => {
                          setFormData(prev => ({
                            ...
                            settings: {
                              ...prev.settings,
                              handoverKeywords:
                                prev.settings.handoverKeywords.filter(
                                  (_, i) => i !== idx
                                ),
                            },
                          }));
                        ...
                        if (input.value.trim()) {
                          setFormData(prev => ({
                            ...
                            settings: {
                              ...prev.settings,
                              handoverKeywords: [
                                ...prev.settings.handoverKeywords,
                                input.value.trim(),
                              ],
                            },
                          }));
          ...
          <div className='border-t pt-4 space-y-4'>
            ...
            {formData.settings.handoverFollowUp.enabled && (
              <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                ...
                <div className='space-y-2'>
                  <Label htmlFor='daysBetweenAttempts'>
                  ...
                  <Input
                    ...
                    type='number'
                    value={
                      formData.settings.handoverFollowUp.daysBetweenAttempts
                    }
                    onChange={e =>
                      setFormData(prev => ({
                        ...prev,
