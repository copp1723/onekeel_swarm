...
export function CampaignList({
  ...
  const [typeFilter, setTypeFilter] = useState<'all' | 'drip' | 'blast' | 'trigger'>('all');
                    ...
                    <div className="flex items-start justify-between">
                      ...
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          ...
                          {onToggleStatus && (
                            <DropdownMenuItem 
                              onClick={() => onToggleStatus(campaign.id, !campaign.active)}
                            >
                              {campaign.active ? (
                                <>
                    ...
                    <div className="space-y-3">
                      ...
                      {executionStatuses[campaign.id] && (
                        <div className="text-sm text-gray-600">
                          <strong>Progress:</strong> {executionStatuses[campaign.id].sentCount || 0} sent, {executionStatuses[campaign.id].failedCount || 0} failed
                          {executionStatuses[campaign.id].totalLeads && (
                            <span> of {executionStatuses[campaign.id].totalLeads} total</span>
                          )}
                        </div>
                      )}
