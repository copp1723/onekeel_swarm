...
export function CampaignIntelligenceHub({
  campaigns,
  onUpdate,
  onNavigateToCampaigns,
}: CampaignIntelligenceHubProps) {
      ...
      <div className='flex items-center justify-between'>
        <div>
          ...
          <p className='text-gray-600'>
            AI-powered agent management and campaign orchestration
          </p>
        </div>
        ...
        <TabsContent value='overview' className='space-y-4'>
          <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4'>
            ...
            <Card>
              ...
              <CardContent>
                <div className='text-2xl font-bold'>
                  {campaigns.filter(c => c.assignedAgents?.length > 1).length}
                </div>
          ...
          <div className='space-y-6'>
            <div className='flex items-center justify-between'>
              <div>
                ...
                <p className='text-gray-600'>
                  Monitor performance across all campaigns and agents
                </p>
              </div>
            </div>
          ...
          <div className='space-y-6'>
            <div>
              ...
              <p className='text-gray-600 text-sm'>
                Configure your email service and send test emails
              </p>
            </div>
            <EmailTestPanel />
          </div>
