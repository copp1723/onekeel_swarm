...
const mockCampaigns: CampaignForApproval[] = [
  {
    id: '1',
    name: 'Q4 Real Estate Push',
    clientName: 'Sunnyvale Homes',
    submittedBy: 'John Doe',
    status: 'pending',
  },
  {
    id: '2',
    name: 'New Year Finance Promo',
    clientName: 'Secure Investments',
    submittedBy: 'Jane Smith',
    status: 'pending',
  },
  {
    id: '3',
    name: 'Spring Healthcare Outreach',
    clientName: 'Wellness Clinic',
    submittedBy: 'John Doe',
    status: 'approved',
  },
];
            ...
            <div className='flex justify-between items-start'>
              <div>
                ...
                <p className='text-xs text-gray-500'>
                  Submitted by: {campaign.submittedBy}
                </p>
              </div>
            ...
            {campaign.status === 'pending' && (
              <div className='mt-4 space-y-2'>
                <Textarea
                  ...
                  onChange={e =>
                    setComments(c => ({ ...c, [campaign.id]: e.target.value }))
                  }
                />
