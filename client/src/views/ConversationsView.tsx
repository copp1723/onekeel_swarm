...
const SAMPLE_CONVERSATIONS = [
  ...
  },
  {
    ...
    status: 'completed',
    lastMessage:
      'Contract signed and returned. Looking forward to getting started next week!',
  ...
  },
  {
    ...
    status: 'active',
    lastMessage:
      "The API integration worked perfectly. I'm ready to move forward with the implementation.",
...
export const ConversationsView: React.FC = () => {
  ...
  return (
    <div className='flex h-[calc(100vh-64px)]'>
      ...
      <div
        className={`w-full md:w-[450px] border-r transition-all duration-200 ${selectedConversation ? 'hidden md:block' : 'block'}`}
      >
        ...
        {selectedConversation ? (
          <div className='h-full'>
            <ConversationThread
              ...
              leadName={
                SAMPLE_CONVERSATIONS.find(c => c.id === selectedConversation)
                  ?.leadName
              }
              leadEmail={
                SAMPLE_CONVERSATIONS.find(c => c.id === selectedConversation)
              ...
              <div className='grid grid-cols-2 gap-4 text-left'>
                <Card className='shadow-sm'>
                  ...
                  <CardContent>
                    <p className='text-sm text-gray-600'>
                      {
                        SAMPLE_CONVERSATIONS.filter(c => c.channel === 'email')
                          .length
                      }{' '}
                      conversations
                    </p>
                ...
                <Card className='shadow-sm'>
                  ...
                  <CardContent>
                    <p className='text-sm text-gray-600'>
                      {
                        SAMPLE_CONVERSATIONS.filter(c => c.channel === 'chat')
                          .length
                      }{' '}
                      conversations
                    </p>
