...
export const EnhancedDashboardView: React.FC = () => {
  ...
  return (
    <div className='p-6 space-y-6'>
      ...
      <div className='mb-8'>
        <h2 className='text-base font-normal text-gray-600 mb-4'>
      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-6'>
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Active campaigns and their metrics
            </CardDescription>
          </CardHeader>
          <CardContent>
                  ...
                  >
                    <div className='flex items-start justify-between mb-2'>
                      <div>
                        ...
                        <span
                          className={`inline-flex items-center px-2 py-0.5 rounded text-xs font-medium ${getStatusColor(campaign.status)}`}
                        >
                          {campaign.status}
                        </span>
                      </div>
  ...
  <div className='p-6 space-y-6'>
    <div>
      ...
      <p className='text-gray-600'>
        Welcome to your AI Marketing Automation Platform
      </p>
    </div>
