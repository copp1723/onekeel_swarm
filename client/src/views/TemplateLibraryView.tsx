...
export const TemplateLibraryView: React.FC = () => {
  ...
  const [categories, setCategories] = useState<TemplateCategory[]>([
    ...
    },
    {
      id: 'follow-up',
      name: 'Follow-up',
      description: 'Lead nurturing and follow-up templates',
      templateCount: 0,
    },
    {
      id: 'promotion',
      name: 'Promotion',
      description: 'Sales and promotional templates',
      templateCount: 0,
    },
    {
      id: 'reminder',
    ...
    },
    {
      id: 'custom',
      name: 'Custom',
      description: 'Custom templates for specific needs',
      templateCount: 0,
    },
  ]);
      ...
      <div className='flex justify-between items-start'>
        <div>
          ...
          <p className='text-gray-600 mt-1'>
            {showGlobal
              ? 'Showing global agency templates'
              : `Showing templates for ${activeClient?.name || 'your organization'}`}
          </p>
        </div>
        <div className='flex items-center space-x-4'>
          <div className='flex items-center space-x-2'>
            <Label htmlFor='global-switch' className='text-sm'>
