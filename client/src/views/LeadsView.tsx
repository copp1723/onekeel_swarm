...
export const LeadsView: React.FC<LeadsViewProps> = ({ onImportLeads }) => {
  ...
  const handleDeleteLead = async (id: string) => {
    if (
      !confirm(`Are you sure you want to delete this ${terminology.singular}?`)
    )
      return;
      ...
      <div className='flex items-center justify-between'>
        <div>
          <h1 className='text-3xl font-bold text-gray-900'>
            {terminology.pluralCapitalized}
          </h1>
          <p className='text-gray-600'>
            Manage your {terminology.singular} database
          </p>
        </div>
                        ...
                        <TableCell className='text-right'>
                          <DropdownMenu>
                            ...
                            <DropdownMenuContent align='end'>
                              <DropdownMenuItem
                                onClick={() =>
                                  handleStartConversation(lead, 'email')
                                }
                              >
                              ...
                              <DropdownMenuItem
                                onClick={() =>
                                  handleStartConversation(lead, 'sms')
                                }
                              >
                              ...
                              <DropdownMenuItem
                                onClick={() =>
                                  handleStartConversation(lead, 'chat')
                                }
                              >
              ...
              {totalPages > 1 && (
                <div className='flex items-center justify-between mt-4'>
                  <p className='text-sm text-gray-600'>
                    ...
                    {Math.min(currentPage * pageSize, totalLeads)} of{' '}
                    {totalLeads} {terminology.plural}
                  </p>
                  <div className='flex items-center space-x-2'>
                    <Button
                      variant='outline'
        ...
        <DialogContent>
          ...
          <div className='space-y-4'>
            <div className='grid grid-cols-2 gap-4'>
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={e =>
                    setAddLeadForm({ ...addLeadForm, lastName: e.target.value })
                  }
                />
              </div>
            </div>
            ...
            <div>
              ...
              <Select
                ...
                onValueChange={value =>
                  setAddLeadForm({ ...addLeadForm, source: value })
                }
              >
            ...
            <div>
              ...
              <Input
                ...
                onChange={e =>
                  setAddLeadForm({ ...addLeadForm, notes: e.target.value })
                }
          ...
          <DialogFooter>
            ...
            >
              {actionLoading
                ? 'Adding...'
                : 'Add ' + terminology.singularCapitalized}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
