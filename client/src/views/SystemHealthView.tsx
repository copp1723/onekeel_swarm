            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-xs text-gray-600 mt-2">{health.schema.message}</p>
                </CardContent>
              </Card>
            </div>
          )}
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <div className="pl-6 space-y-1">
                        ...
                        <div className="flex justify-between text-sm">
                          ...
                          <span>{new Date(health.database.lastChecked).toLocaleTimeString()}</span>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="pl-6 space-y-1">
                        ...
                        <div className="flex justify-between text-sm">
                          <span>Last Checked:</span>
                          <span>{new Date(health.redis.lastChecked).toLocaleTimeString()}</span>
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              {health?.services && (
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <Card>
                    ...
                    <CardContent>
                      <div className="flex items-center justify-between mb-2">
                        <Badge className={getStatusColor(health.services.mailgun.status)}>
                      ...
                      <p className="text-xs text-gray-600 mb-2">{health.services.mailgun.message}</p>
                      <div className="flex items-center space-x-2 text-xs">
                        <span className={`w-2 h-2 rounded-full ${health.services.mailgun.configured ? 'bg-green-500' : 'bg-red-500'}`}></span>
                        <span>Configured</span>
                        <span className={`w-2 h-2 rounded-full ${health.services.mailgun.connected ? 'bg-green-500' : 'bg-red-500'}`}></span>
                        <span>Connected</span>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="flex items-center justify-between mb-2">
                        <Badge className={getStatusColor(health.services.twilio.status)}>
                      ...
                      <p className="text-xs text-gray-600 mb-2">{health.services.twilio.message}</p>
                      <div className="flex items-center space-x-2 text-xs">
                        <span className={`w-2 h-2 rounded-full ${health.services.twilio.configured ? 'bg-green-500' : 'bg-red-500'}`}></span>
                        <span>Configured</span>
                        <span className={`w-2 h-2 rounded-full ${health.services.twilio.connected ? 'bg-green-500' : 'bg-red-500'}`}></span>
                        <span>Connected</span>
                      </div>
                    </CardContent>
                  </Card>
                  ...
                  <Card>
                    ...
                    <CardContent>
                      <div className="flex items-center justify-between mb-2">
                        <Badge className={getStatusColor(health.services.openrouter.status)}>
                      ...
                      <p className="text-xs text-gray-600 mb-2">{health.services.openrouter.message}</p>
                      <div className="flex items-center space-x-2 text-xs">
                        <span className={`w-2 h-2 rounded-full ${health.services.openrouter.configured ? 'bg-green-500' : 'bg-red-500'}`}></span>
                        <span>Configured</span>
                        <span className={`w-2 h-2 rounded-full ${health.services.openrouter.connected ? 'bg-green-500' : 'bg-red-500'}`}></span>
                        <span>Connected</span>
                      </div>
                    </CardContent>
                  </Card>
          ...
          {performance && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{performance.database.connections}</div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{performance.database.queryTime}ms</div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{performance.database.slowQueries}</div>
          ...
          {business && (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{business.smsMessages}</div>
                  <p className="text-xs text-gray-500 mt-1">Today</p>
                </CardContent>
              </Card>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{business.campaignsActive}</div>
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">{business.systemLoad}%</div>
