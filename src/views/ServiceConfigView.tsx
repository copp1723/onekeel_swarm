  ...
  return (
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-gray-600">Configure and manage external service integrations</p>
      </div>
        ...
        <CardContent>
          {editMode === 'email' ? (
            ...
            <div className="space-y-2">
              <div><strong>Domain:</strong> {configs.email.domain}</div>
              <div><strong>Provider:</strong> {configs.email.provider}</div>
            </div>
          )}
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          {editMode === 'sms' ? (
            ...
            <div className="space-y-2">
              <div><strong>Phone Number:</strong> {configs.sms.phoneNumber}</div>
              <div><strong>Provider:</strong> {configs.sms.provider}</div>
            </div>
          )}
        </CardContent>
      </Card>
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-2">
            <div><strong>Host:</strong> {configs.database.host}</div>
            <div><strong>Port:</strong> {configs.database.port}</div>
            <div><strong>Database:</strong> {configs.database.database}</div>
          </div>
        </CardContent>
      </Card>
    </div>
