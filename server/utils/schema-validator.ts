...
export class SchemaValidator {
      ...
      try {
        ...
        for (const column of actualColumns) {
          if (!columns.includes(column)) {
            addInfo(
              result,
              `Additional column found in ${tableName}: ${column}`
            );
          }
        }
      } catch (error) {
        addError(
          result,
          `Error checking columns for table ${tableName}: ${error.message}`
        );
      }
    }
  ...
  async validateIndexes(): Promise<ValidationResult> {
    ...
    const expectedIndexes: { [key: string]: string[] } = {
      ...
      agent_configurations: [
        'agent_configurations_name_idx',
        'agent_configurations_type_idx',
        'agent_configurations_active_idx',
      ],
      agent_templates: [
        'agent_templates_name_idx',
        'agent_templates_type_idx',
        'agent_templates_category_idx',
        'agent_templates_is_default_idx',
      ],
      leads: [
        'leads_email_idx',
        'leads_phone_idx',
        'leads_status_idx',
        'leads_source_idx',
        'leads_assigned_channel_idx',
        'leads_boberdoo_id_idx',
        'leads_campaign_id_idx',
        'leads_created_at_idx',
      ],
      campaigns: [
        'campaigns_name_idx',
        'campaigns_active_idx',
        'campaigns_type_idx',
      ],
      communications: [
        'communications_lead_id_idx',
        'communications_campaign_id_idx',
        'communications_channel_idx',
        'communications_status_idx',
        'communications_created_at_idx',
      ],
      templates: [
        'templates_name_idx',
        'templates_channel_idx',
        'templates_category_idx',
        'templates_active_idx',
      ],
      campaign_steps: [
        'campaign_steps_campaign_id_idx',
        'campaign_steps_order_idx',
      ],
      lead_campaign_enrollments: [
        'enrollments_lead_campaign_idx',
      ...
      analytics_events: [
        ...
        'analytics_events_lead_id_idx',
        'analytics_events_campaign_id_idx',
        'analytics_events_created_at_idx',
      ],
      feature_flags: [
        'feature_flags_key_idx',
        'feature_flags_category_idx',
        'feature_flags_enabled_idx',
        'feature_flags_created_at_idx',
      ],
      feature_flag_user_overrides: [
        'feature_flag_user_overrides_flag_user_idx',
      ],
    };
      ...
      for (const [tableName, indexes] of Object.entries(expectedIndexes)) {
        ...
        for (const index of indexes) {
          if (!existingIndexSet.has(index)) {
            addWarning(
              result,
              `Missing recommended index: ${index} on table ${tableName}`
            );
          } else {
