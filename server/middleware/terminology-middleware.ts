...
export const terminologyMiddleware = async (
  req: TerminologyRequest,
  res: Response,
  next: NextFunction
) => {
  try {
...
export const terminologyResponseMiddleware = (
  req: TerminologyRequest,
  res: Response,
  next: NextFunction
) => {
  ...
  res.json = function (data: any) {
    ...
    if (!jsonOverridden) {
      ...
      if (req.terminologyMode && req.terminologyMode !== 'legacy') {
        ...
        const transformedData = dualTerminologyService.getApiResponse(
          data,
          req.terminologyMode
        );
...
export const terminologyHeaderMiddleware = (
  req: TerminologyRequest,
  res: Response,
  next: NextFunction
) => {
