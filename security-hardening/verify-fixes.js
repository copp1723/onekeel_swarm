...
const securityChecks = [
  {
    ...
    checkFunction: content => {
      return content.includes(
        "username === 'admin@onekeel.com' && password === 'password123'"
      );
    },
  },
  {
    ...
    vulnerability:
      'SKIP_AUTH environment variable allows authentication bypass',
    checkFunction: content => {
  ...
  },
  {
    ...
    checkFunction: content => {
      return content.includes(
        "JWT_SECRET || 'ccl3-jwt-secret-change-in-production'"
      );
    },
  },
  {
  ...
  },
  {
    ...
    checkFunction: content => {
      ...
      return (
        ...
        !content.includes('sanitizeRequestBody')
      );
    },
  },
];
...
function main() {
  ...
  console.log(
    `Status: ${vulnerabilitiesFound === 0 ? 'SECURE ✅' : 'VULNERABLE ❌'}`
  );
  ...
  if (vulnerabilitiesFound > 0) {
    ...
    console.log(
      "Agent 1's fixes have NOT been applied to the actual codebase."
    );
  }
}
